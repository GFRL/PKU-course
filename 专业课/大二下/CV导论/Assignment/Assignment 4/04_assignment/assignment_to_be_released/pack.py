...
def zipHW4(input_path: str, output_path: str, zip_name: str):
    ...
    result_files = {
        ...
        'RNN':['rnn.py', 'rnn_layers.py'] + [f'results/pred_{split}_{i}.png' for i in range(2) for split in ['train', 'val']] + ['results/rnn_loss_history.png', 'results/single_rnn_layer.npy', 'results/rnn.npy', 'results/attention.npy']
    }
